    ...
    e.prototype = {
        _get: function () {
            ...
            if (b.opts.json) {
                ...
                return c.resolve(b.opts.json[b._pathToString()]),
                c.promise()
            }
            var d = b.opts.data;
            return d.path = b._pathToString(),
            a.ajax({
                url: b.opts.url,
                dataType: "json",
                type: b.opts.method,
        ...
        _draw: function (b) {
            ...
            c.opts.breadcrumbs && (c.$elements.breadcrumbs.html(""), a.each(c.path, function (b, d) {
                    var e = "" == d ? '<i class="fa fa-home" style="font-size:22px"></i> Paftalar' : d,
                    f = a("<li />").data("path", c._pathToString(b + 1)).html(e);
        ...
        init: function () {
            ...
            b.$element.html(""),
            b.$element.addClass("sfb"),
            1 == b.opts.breadcrumbs && (b.$elements.breadcrumbs = a("<ul />").addClass("sfbBreadCrumbs"), b.$element.append(b.$elements.breadcrumbs), b.$elements.breadcrumbs.on("click", "li", function () {
                    var c = a(this);
            ...
            b.$elements.content = a("<div />").addClass("sfbContent"),
            ...
            b.$elements.content.on("click", "li", function () {
                ...
                1 === e ? f = setTimeout(function () {
                        b.opts.select ? d(g) : c(g),
                        e = 0
                    }, 200) : (clearTimeout(f), b.opts.select && d(g), c(g), e = 0)
            }),
            b._get().then(function (a) {
                b._draw(a),
                b.opts.onLoad.call(b, b)
            })
        },
        remove: function () {
            this.html(""),
            this.$element.removeData("plugin_" + f),
