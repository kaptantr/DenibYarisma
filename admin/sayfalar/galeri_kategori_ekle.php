...
if(p('kategori_adi') && g('islem')=="")
{
	...
	$kategori_sorgu	=	mysqli_query($GLOBALS['baglan'], "INSERT INTO galeri_kategori SET
...
if(p('kategori_adi') && g('islem')=="duzenle")
{
	...
	if($KategoriResim!="")
	{
		$resim_bul=mysqli_fetch_object(mysqli_query($GLOBALS['baglan'], "SELECT * FROM galeri_kategori WHERE id='$d_id'"));
